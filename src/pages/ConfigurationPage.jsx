      ...
      <div style={s.container}>
        ...
        <div style={s.section}>
          ...
          <div style={s.canchasGroup}>
            <label style={s.label}>
              Canchas disponibles{' '}
              <span style={s.labelHint}>(la asignación se hace al programar cada partido)</span>
            </label>
        ...
        {/* Footer */}
        <div style={{ ...s.footerBtn, alignItems: 'center' }}>
          {guardado && (
            <span style={{ fontSize: '0.82rem', color: '#2d9e6b', fontWeight: '600', marginRight: 'auto' }}>
