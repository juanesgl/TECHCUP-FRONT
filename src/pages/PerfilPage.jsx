      ...
      <div style={s.container}>
        ...
        <div style={s.headerCard}>
          <div style={s.fotoWrap} onClick={() => fileRef.current?.click()} title="Cambiar foto">
            {form.foto
              ...
              : <div style={s.fotoPlaceholder}><span style={{ fontSize: '2.5rem' }}>👤</span></div>
            }
        ...
        <div style={s.formGrid}>
          ...
          <div style={s.field}>
            ...
            <select style={s.select} value={form.parentesco}
          ...
          <>
            ...
            <div style={s.posicionesGrid}>
              {POSICIONES.map(p => {
                ...
                return (
                  <div key={p.id} onClick={() => togglePosicion(p.id)}
                    style={{ ...s.posCard, ...(activo ? s.posCardActive : {}) }}>
                    <span style={s.posIconoGrande}>{p.icono}</span>
                    <span style={{ ...s.posLabel, color: activo ? '#2d9e6b' : '#888' }}>
                      {p.label}
                    </span>
