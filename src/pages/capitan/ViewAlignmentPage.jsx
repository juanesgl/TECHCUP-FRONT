...
const JUGADORES_CANCHA = [
  ...
  { nombre: 'La Rocka',  posicion: 'Defensa',   x: 25, y: 25, color: '#3b82f6' },
  { nombre: "Di'Caprio", posicion: 'Defensa',   x: 25, y: 75, color: '#3b82f6' },
  { nombre: 'Al Pacino', posicion: 'Medio',     x: 48, y: 20, color: '#2d9e6b' },
  { nombre: 'Disel',     posicion: 'Medio',     x: 48, y: 80, color: '#2d9e6b' },
  { nombre: 'Dextarino', posicion: 'Delantero', x: 72, y: 35, color: '#e53e3e' },
  { nombre: 'Pitbull',   posicion: 'Delantero', x: 72, y: 65, color: '#e53e3e' },
];
          ...
          <div style={s.panel}>
            ...
            <div style={{ ...s.card, marginTop: '0.75rem' }}>
              ...
              {JUGADORES_CANCHA.map((j, i) => (
                <div key={i} style={{ ...s.supRow, cursor: 'pointer' }} onClick={() => setSeleccionado(j)}>
...
export default ViewAlignemntPage;